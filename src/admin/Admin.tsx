      ...
      <main className="max-w-2xl mx-auto p-4 md:p-6">
        <Section title="Geral">
          <label className="flex items-center gap-2 mb-4 cursor-pointer select-none">
            <input
              type="checkbox"
              checked={c.menuEnabled ?? false}
              onChange={(e) => up({ menuEnabled: e.target.checked })}
              className="w-4 h-4"
            />
            <span className="text-sm font-semibold text-neutral-700">
              Exibir menu de navegação (botão “Menu” / hambúrguer)
            </span>
          </label>
          <p className="text-xs text-neutral-500 -mt-3 mb-4">
            Desligado: apenas o logo aparece no cabeçalho. Ligue quando criar
            novas páginas para exibir o menu ao rolar a tela.
          </p>
