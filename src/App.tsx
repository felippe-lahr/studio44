  ...
  return (
    <>
      <nav
        ...
        className={`fixed top-0 left-0 right-0 z-50 grid grid-cols-3 items-center px-4 md:px-6 py-2 backdrop-blur-md transition-all duration-300 ${
          menuVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-full pointer-events-none'
        }`}
      >
        {/* Espaçador esquerdo */}
        <div />
  ...
  return (
    ...
    >
      <svg
        ...
        aria-hidden="true"
      >
        <path d="M16.003 3.2c-7.06 0-12.8 5.74-12.8 12.8 0 2.257.593 4.464 1.72 6.408L3.2 28.8l6.56-1.712a12.74 12.74 0 0 0 6.24 1.616h.005c7.06 0 12.8-5.74 12.8-12.8 0-3.42-1.332-6.635-3.752-9.056A12.716 12.716 0 0 0 16.003 3.2zm0 23.36h-.004a10.57 10.57 0 0 1-5.386-1.475l-.386-.23-3.893 1.017 1.04-3.797-.252-.39a10.56 10.56 0 0 1-1.62-5.638c0-5.86 4.77-10.63 10.634-10.63a10.56 10.56 0 0 1 7.515 3.117 10.56 10.56 0 0 1 3.113 7.52c0 5.86-4.77 10.63-10.63 10.63zm5.83-7.96c-.32-.16-1.89-.933-2.183-1.04-.293-.107-.507-.16-.72.16-.213.32-.826 1.04-1.013 1.253-.187.213-.373.24-.693.08-.32-.16-1.35-.498-2.57-1.586-.95-.847-1.59-1.893-1.777-2.213-.187-.32-.02-.493.14-.653.144-.143.32-.373.48-.56.16-.187.213-.32.32-.533.107-.213.053-.4-.027-.56-.08-.16-.72-1.733-.986-2.373-.26-.624-.523-.54-.72-.55l-.613-.01c-.213 0-.56.08-.853.4-.293.32-1.12 1.093-1.12 2.667 0 1.573 1.146 3.093 1.306 3.307.16.213 2.253 3.44 5.46 4.824.763.33 1.36.526 1.824.674.767.244 1.464.21 2.016.127.615-.092 1.89-.773 2.157-1.52.266-.746.266-1.386.186-1.52-.08-.133-.293-.213-.613-.373z" />
      </svg>
    </a>
  );
}
